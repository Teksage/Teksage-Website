...
export const SETTINGS_SECTION_SUBTITLE = {
  ...
  "delete-account": "We're sorry to see you go. Tell us why so we can improve.",
} as const;
...
export const SETTINGS_LAYOUT = {
  ...
  pageTitle: `${TYPO.h1} tracking-tight text-[var(--color-brand-black)]`,
  pageSubtitle: `${TYPO.chatBubble} mt-1 max-w-2xl text-black/45`,
  ...
  subpageTitle: `${TYPO.h1} tracking-tight text-[var(--color-brand-black)]`,
  subpageSubtitle: `${TYPO.chatBubble} mt-1 max-w-xl text-black/45`,
  subpageAction: "shrink-0 pt-0.5",
  contentCard:
    `${TYPO.chatCardTextBot} overflow-hidden rounded-2xl border border-[var(--color-chat-bot-border)] bg-[var(--color-chat-bot-bubble)] shadow-[0_1px_6px_rgb(0_0_0_/_0.06)]`,
  contentCardBody: "p-2 sm:p-3",
  contentCardPad: "px-5 py-4 sm:px-6 sm:py-5",
  sectionsGrid: "grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-5",
  sectionCard:
    "overflow-hidden rounded-2xl border border-[var(--color-chat-bot-border)] bg-[var(--color-chat-bot-bubble)] shadow-[0_1px_6px_rgb(0_0_0_/_0.06)]",
  sectionHeader:
