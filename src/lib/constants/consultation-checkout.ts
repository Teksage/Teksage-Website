...
export const CONSULTATION_CHECKOUT_LAYOUT = {
  ...
  inner: `${CONSULTATION_CHECKOUT_PAGE_MAX} mx-auto grid w-full grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1fr)_380px] lg:items-start lg:gap-6`,

  leftCol: "flex min-w-0 flex-col gap-4",
  ...
  astroAvatarInitials: `${TYPO.sizeXs} sm:text-sm ${TYPO.weightBold} flex size-full items-center justify-center text-[var(--color-chat-consult-btn-text)]`,
  ...
  outlineBtn:
    `${TYPO.sizeXs} ${TYPO.weightBold} shrink-0 cursor-pointer rounded-xl border border-black/15 bg-white px-3.5 py-2 text-black/70 transition-colors hover:border-black/30`,
  ...
  focusChip: `${TYPO.sizeSm} ${TYPO.weightSemibold} cursor-pointer rounded-full border px-3.5 py-1.5 transition-colors`,
  focusChipActive:
    "border-[var(--color-brand-primary)] bg-[var(--color-brand-primary)] text-white",
  focusChipDefault: "border-black/15 bg-white text-black/65 hover:border-black/25",
  focusTextarea: `mt-3 w-full resize-none rounded-xl border border-black/[0.09] bg-white px-3.5 py-3 ${TYPO.sizeSm} ${TYPO.weightMedium} text-black/70 placeholder:text-black/35 focus:outline-none focus:ring-1 focus:ring-[var(--color-brand-primary)]/40`,

  rightCol: "flex flex-col gap-4 lg:sticky lg:top-4",
  payCard: `${CONSULTATION_CHECKOUT_CARD} p-4 sm:p-5`,
  ...
  promoBtn: `${TYPO.sizeSm} ${TYPO.weightBold} shrink-0 cursor-pointer rounded-xl border border-[var(--color-brand-primary)] bg-white px-4 py-2.5 text-[var(--color-brand-primary)] transition-opacity hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-40`,
  ...
  payBtn: `${TYPO.sizeBase} ${TYPO.weightExtrabold} mt-4 block w-full cursor-pointer rounded-xl py-3.5 text-center text-white shadow-[0_6px_18px_rgb(16_177_0_/0.22)] transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:bg-black/20 disabled:text-white/80 disabled:shadow-none enabled:bg-[var(--color-brand-primary)]`,
  trustCard: `rounded-2xl border border-[color-mix(in_srgb,var(--color-brand-primary)_18%,white)] ${CONSULTATION_CHECKOUT_BIRTH_CELL_BG} p-4 sm:p-5`,
