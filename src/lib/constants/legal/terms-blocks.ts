...
/** Full copy from Flutter `t&c_page.dart`. */
export const TERMS_LEGAL_BLOCKS: readonly LegalBlock[] = [
  ...
  },
  {
    ...
    body: "These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.\n\nYour access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.\n\nBy accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any part of these Terms and Conditions then You may not access the Service.\n\nYou represent that you are over the age of 18. The Company does not permit those under 18 to use the Service.\n\nYour access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully before using Our Service.",
  },
  {
    type: "subsection",
    title: "Informational Purposes Only:",
    body: "The astrological insights and predictions provided by Teksage are intended for informational and guidance purposes only. Astrology is a science of tendencies, not certainties, and should not be interpreted in a fatalistic or deterministic manner—whether applied at an individual or collective level.",
  },
  {
    type: "subsection",
    title: "No Guarantee of Accuracy",
    body: "While we aim to offer accurate and personalized readings, astrology is inherently interpretive. Teksage and its creators make no guarantees regarding the accuracy, completeness, or reliability of any astrological predictions or content.",
  },
  {
    type: "subsection",
    title: "User Responsibility",
    body: "You as a user are solely responsible for any decisions or actions they take based on the astrological insights or guidance offered through Teksage. The Company assumes no liability for consequences arising from reliance on the information provided by the app.",
  },
  {
    type: "subsection",
    title: "Not a Substitute for Professional Advice",
    body: "Astrological guidance should not replace professional advice. For matters involving health, finance, law, or other specialized domains, please consult qualified professionals. Teksage does not provide medical, legal, or financial advice, and its content should not be interpreted as such.",
  },
  {
    type: "subsection",
    title: "Links to Other Websites",
    body: "Our Service may contain links to third-party web sites or services that are not owned or controlled by the Company.\n\nThe Company has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that the Company shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods or services available on or through any such web sites or services.\n\nWe strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or services that You visit.",
  },
  {
    type: "subsection",
    title: "Termination",
  ...
  },
  {
    type: "subsection",
    title: "Governing Law",
    body: "The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.",
  },
  {
    type: "subsection",
  ...
  { type: "heading", text: "Severability and Waiver" },
  {
    type: "subsection",
    title: "Severability",
