...
export const HOROSCOPE_SCREEN = {
  ...
  /** More section inner sub-tabs */
  moreTabPlanets: "Planets",
  moreTabBhava: "Bhava",
  moreTabShadbala: "Shadbala",
  moreTabLagna: "Lagna",
  moreTabEphemeris: "Ephemeris",
  /** Ephemeris */
  ephemerisLabel: "Planetary Snapshot",
  ephemerisNote: "Showing birth-chart planetary positions. Full day-by-day ephemeris coming soon.",
